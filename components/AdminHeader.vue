<template>
  <header class="sticky top-0 z-40 bg-neutral-950/95 backdrop-blur-md border-b border-neutral-800">
    <div class="flex items-center justify-between px-6 py-4">
      ...
      <div class="flex items-center gap-4">
        ...
        <!-- Notifications -->
        <button class="relative p-2 rounded-lg hover:bg-neutral-900 transition-colors">
        ...
        <!-- Settings -->
        <button class="p-2 rounded-lg hover:bg-neutral-900 transition-colors">
          <svg class="w-6 h-6 text-neutral-400 hover:text-primary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
